...
def file_watcher_glob(watch_dir: Path, patterns: List[str], prev_files: Dict[str, float]) -> Dict[str, float]:
    ...
    Args:
        watch_dir (Path): This directory will be watched (recursively) for file changes.
    ...
    """
    changed_files = {}
    file_patterns = [str(watch_dir / f'**/{pattern}') for pattern in patterns]
